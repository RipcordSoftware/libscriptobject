...
${OBJECTDIR}/script_item_ptr.o: script_item_ptr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG_SCRIPT_OBJECT=1 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/script_item_ptr.o script_item_ptr.cpp
...
${OBJECTDIR}/script_item_ptr_nomain.o: ${OBJECTDIR}/script_item_ptr.o script_item_ptr.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DDEBUG_SCRIPT_OBJECT=1 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/script_item_ptr_nomain.o script_item_ptr.cpp;\
	else  \
