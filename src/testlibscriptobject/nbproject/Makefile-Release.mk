...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/gason/src -I../libscriptobject -I../libscriptobject_gason -I../libscriptobject_msgpack -I../../externals/msgpack-c/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

# Subprojects
.build-subprojects:
	cd ../libscriptobject && ${MAKE}  -f Makefile CONF=Release
	cd ../libscriptobject_gason && ${MAKE}  -f Makefile CONF=Release
	cd ../libscriptobject_msgpack && ${MAKE}  -f Makefile CONF=Release
...
.clean-subprojects:
	...
	cd ../libscriptobject_gason && ${MAKE}  -f Makefile CONF=Release clean
	cd ../libscriptobject_msgpack && ${MAKE}  -f Makefile CONF=Release clean
