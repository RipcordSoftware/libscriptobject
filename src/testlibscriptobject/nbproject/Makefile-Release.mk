...
LDLIBSOPTIONS=../../externals/installed/lib/libjsoncpp.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testlibscriptobject

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testlibscriptobject: ../../externals/installed/lib/libjsoncpp.a
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/installed/include -I../libscriptobject -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/script_object_json_source.o: script_object_json_source.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../externals/installed/include -I../libscriptobject -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/script_object_json_source.o script_object_json_source.cpp
